        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-6 text-center md:text-left lg:col-span-1">
            <div className="flex items-center gap-4 justify-center md:justify-start">
              <div className="bg-gradient-to-br from-green-700 to-green-900 p-3 rounded-xl shadow-lg">
                <img
                  src="/logo.png"
                  alt="BNP Logo"
            ...
            <p className="text-sm leading-relaxed text-gray-400 max-w-xs mx-auto md:mx-0">
              Committed to democratic values, national unity, and the welfare of the people of Bangladesh.
            </p>
            
            {/* Social Icons */}
            <div className="flex gap-3 justify-center md:justify-start hidden">
              <a href="#" className="w-10 h-10 bg-gray-800 hover:bg-green-700 rounded-full flex items-center justify-center transition-all duration-300 transform hover:scale-110">
      ...
      <div className="max-w-7xl mx-auto py-6 px-6 md:px-8">
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-gray-400">
          ...
          <div className="flex items-center gap-2 flex-wrap justify-center">
            ...
            <span className="text-gray-500">Helped by <span className="text-green-500 hover:text-green-400 font-medium">BREAK THE MALT</span></span>
          </div>
        </div>
      </div>
    </footer>
